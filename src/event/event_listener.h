...
namespace mkr {
    ...
    */
    ...
    private:
        ...
        std::function<void(const event*)> callback_ = nullptr;
    ...
    public:
        ...
        */
        void set_callback(const std::function<void(const event*)>& _callback) {
            callback_ = _callback;
        }
        ...
        */
        void invoke_callback(const event* _event) {
            if (callback_ != nullptr) { std::invoke(callback_, _event); }
        }
    };
}