...
namespace mkr {
    ...
    public:
        ...
        static shader_program *gshader_, *lshader_, *sshader_;
        static std::vector<shader_program*> pshaders_;

        render_path render_path_ = render_path::deferred;
        shader_program* fshader_; // Only used for forward rendering.
